...
The UNet used to segment has an additional classification head.
This was done to hopefully allow the model to better highlight differences in class
in the output segmentation masks.
"""
#testchange
## IMPORTS
import numpy as np
